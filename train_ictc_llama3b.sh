...
#SBATCH --job-name=ictc_train_llama3b
#SBATCH --output=/scratch/sadeniji/logs/train_llama3b_%j.out
#SBATCH --error=/scratch/sadeniji/logs/train_llama3b_%j.err

mkdir -p /scratch/sadeniji/logs
mkdir -p /scratch/sadeniji/ictc_checkpoints_llama3b
...
cd ~/3d_compression
python scripts/train_ctclip.py --config configs/ctclip_stage2_llama3b.yaml
