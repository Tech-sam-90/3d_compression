...
#SBATCH --job-name=ictc_train_stage1
#SBATCH --output=/scratch/sadeniji/logs/stage1_%j.out
#SBATCH --error=/scratch/sadeniji/logs/stage1_%j.err

mkdir -p /scratch/sadeniji/logs
mkdir -p /scratch/sadeniji/ictc_checkpoints_stage1
...
cd ~/3d_compression
python scripts/train_ctclip.py --config configs/ctclip_stage1.yaml
