...
#SBATCH --job-name=ictc_train_stage2
#SBATCH --output=/scratch/sadeniji/logs/stage2_%j.out
#SBATCH --error=/scratch/sadeniji/logs/stage2_%j.err

mkdir -p /scratch/sadeniji/logs
mkdir -p /scratch/sadeniji/ictc_checkpoints_stage2_final
...
cd ~/3d_compression
python scripts/train_ctclip.py --config configs/ctclip_stage2_final.yaml
