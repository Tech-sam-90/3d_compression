...
#SBATCH --time=0:45:00
#SBATCH --job-name=ictc_test3_vfilm_fix
#SBATCH --output=/scratch/sadeniji/logs/test3_vfilm_fix_%j.out
#SBATCH --error=/scratch/sadeniji/logs/test3_vfilm_fix_%j.err
...
cd ~/3d_compression
python3 scripts/diagnostics/test3_full_rerun_vfilm_fix.py
