...
#SBATCH --time=0:45:00
#SBATCH --job-name=ictc_test3_llama3b_attn
#SBATCH --output=/scratch/sadeniji/logs/test3_llama3b_attn_%j.out
#SBATCH --error=/scratch/sadeniji/logs/test3_llama3b_attn_%j.err
...
cd ~/3d_compression
python3 scripts/diagnostics/test3_full_rerun_llama3b_attncond.py
