...
#SBATCH --job-name=ictc_check_vfilm_scan_diversity
#SBATCH --output=/scratch/sadeniji/logs/check_vfilm_scan_diversity_%j.out
#SBATCH --error=/scratch/sadeniji/logs/check_vfilm_scan_diversity_%j.err
