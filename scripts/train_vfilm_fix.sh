...
#SBATCH --job-name=ictc_vfilm_fix
#SBATCH --output=/scratch/sadeniji/logs/vfilm_fix_%j.out
#SBATCH --error=/scratch/sadeniji/logs/vfilm_fix_%j.err

mkdir -p /scratch/sadeniji/logs
mkdir -p /scratch/sadeniji/ictc_checkpoints_vfilm_fix
...
python scripts/train_ctclip.py --config configs/ctclip_vfilm_fix.yaml
