...
#SBATCH --time=1:00:00
#SBATCH --job-name=ictc_smoke_llama3b
#SBATCH --output=/scratch/sadeniji/logs/smoke_llama3b_%j.out
...
cd ~/3d_compression
python scripts/train_ctclip.py --config configs/narval_smoke_llama3b.yaml
